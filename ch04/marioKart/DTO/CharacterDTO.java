...
//필드
	...
	public String toString() {//객체 필드 정보 출력
		return "CharacterDTO[name="+name+"|weight="+weight+"|speed="+speed+
				"|acceleration="+acceleration+"|handling"+handling+"|friction="+friction+"]";
	}
